...
struct StirringView: View {
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            let cauldronWidth = geo.size.width * 0.3
            ...
            ZStack {
                ...
                ZStack {
                    ...
                    Circle()
                        ...
                        .frame(width: cauldronWidth * 1.2, height: cauldronWidth * 0.75)
                        .blur(radius: 8)
                ...
                // 5. Instruksi Kucing
                if progress < 0.9 {
                    WitchInstructionView(bubbleText: "Stir the potion until the chaos clears...") {}
                        .frame(width: 320)
                        .position(x: geo.size.width * 0.20, y: geo.size.height * 0.82)
                }
            }
        }
    }
